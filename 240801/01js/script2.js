...
// 반드시 new라는 예약어를 사용해야하고, 무조건 대문자로 시작해야한다.
// 프로미스의 콜백함수의 인자값으로 들어오는 함수: resolve, reject
// 어떤 함수가 실행되고 종료됨과 동시에 또다른 함수를 실행시키고 싶기 때문에 콜백함수를 사용하게됨.
// 약속 => 함수가 정상적으로 실행되고 종료된 후, 다음 함수를 실행할 수 있도록 예약
